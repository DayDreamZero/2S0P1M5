<%@ Page Language="C#" AutoEventWireup="true" CodeFile="admin-Librarian-edit.aspx.cs" Inherits="aspx_admin_Librarian_edit" %>
		...
		<ul class="nav navbar-nav">
			...
			<li class="dropdown">
				...
				<ul class="dropdown-menu">
					<li><a href="../admin/admin-Setlendnum.aspx">SetMaxBorrowd</a></li>
                                ...
                                <div class="librarian-list-item">
                                    ...
                                    <div class="col-xs-4">
                                        ...
                                        <div>
                                         ...
                                         <p><br /></p>
                                        <asp:Button ID="btnSave" Text ="Submit" runat="server" CausesValidation="false" Width="80px" Height="30px" OnClick ="btnSave_Click" style="background-color: #07938A;border-radius: 2px;color: white;border: solid;border-color: #07938A;"/>
                                    ...
                                    <div class="librarian-info col-xs-5">
                                        ...
                                        <p>Password：</p>
                                        <p><br /></p>
                                        <asp:Label ID="psd" runat ="server" Height="30px" Width="150px"></asp:Label>
                                        ...
                                        <div>
                                            <asp:Button ID="button3" Text ="Return" runat="server" CausesValidation="false" Width="70px" Height="30px" OnClick ="Button3_Click" style="background-color: #07938A;border-radius: 2px;color: white;border: solid;border-color: #07938A;"/>
                                        &nbsp;&nbsp;
