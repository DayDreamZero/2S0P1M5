<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EReaderHistory.aspx.cs" Inherits="History" %>
...
<head runat="server">
    ...
    <title>BiblioSoft_ReaderHistory</title>
        ...
        <div class="row">
            <div class="col-sm-2" style="border-right: solid 1px">
                <div class="list-group side-bar">
					...
					<a href="EReaderHistory.aspx" class="list-group-item active">Reader History</a>                    
                </div>
            </div>
            <div class="col-sm-10">
                <form id="form1" runat="server">
					<div>
                        ...
                        <asp:TextBox ID="id" runat="server" AUTOCOMPLETE="OFF" CssClass="hmf-textbox" style="width: 100px;"></asp:TextBox>
						...
						&nbsp;<asp:Label ID="Label3" runat="server" Text="Book_Status:"></asp:Label>
						...
						&nbsp;<asp:Label ID="Label4" runat="server" Text="Fine_Status:"></asp:Label>
