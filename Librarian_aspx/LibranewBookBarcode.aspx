<%@ Page Language="C#" AutoEventWireup="true" CodeFile="LibranewBookBarcode.aspx.cs" Inherits="Librarian_aspx_LibranewBookBarcode" %>
...
<head runat="server">
    ...
    <title>BiblioSoft_NewBarcode</title>
...
<body>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-sm-10">
                <asp:Label ID="Label1" runat="server" Text="Barcodes of New books" Font-Size="X-Large"></asp:Label>
                <form id="form1" runat="server">
                    ...
                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" Width="100%" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="4" ForeColor="Black" GridLines="Horizontal" ShowHeaderWhenEmpty="True" UseAccessibleHeader="false" EmptyDataText="None" CellSpacing="4">
                        <Columns>
                            ...
                            <asp:BoundField DataField="barcode" HeaderText="Barcode Number" />
                            <asp:TemplateField HeaderText="Barcode image">
                                <ItemTemplate>
                                    <div style="height:3px"></div>
                                    <asp:Image ID="barcodeImage" ImageUrl='<%#Eval("barcode_image") %>' runat="server" />
                                    <div style="height:3px"></div>
                                </ItemTemplate>
                            </asp:TemplateField>
                        </Columns>
                    ...
                    <p>
                        <asp:Button ID="ComebackBt" runat="server" Text="Comeback" OnClick="ComebackBt_Click" CssClass="hmf-button" />
                    </p>
                </form>
            </div>
        </div>
