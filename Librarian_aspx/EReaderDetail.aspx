<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EReaderDetail.aspx.cs" Inherits="EReaderDetail" %>
...
<head runat="server">
    ...
    <title>BiblioSoft_ReaderInfo</title>
                ...
                <td class="auto-style2">
                    <table style="font-size: 10pt; width: 100%; text-align:center; padding: 0;border-collapse: separate; border-spacing: 10px;">
                        ...
                        <tr style="color: #000000">
                            ...
                            <td style="width: 359px; text-align:left;">
                                ...
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ControlToValidate="txtPhone"
                                    ErrorMessage="The telephone cannot be empty！" ForeColor="#CC0000" Display="Dynamic"></asp:RequiredFieldValidator></td>
							</tr>
						<tr>
                            <td style="width: 19px; height: 19px ;text-align:center;">
                            </td>
                            ...
                            <td style="width: 359px; text-align:left;">
                                ...
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ControlToValidate="txtEmail"
                                    ErrorMessage="The email cannot be empty！"  ForeColor="#CC0000" Display="Dynamic"></asp:RequiredFieldValidator>
								<asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server"  ControlToValidate="txtEmail" Display="Dynamic" ErrorMessage="The email format is wrong" ForeColor="#CC0000"  ValidationExpression="^$|^\w+([-+.]\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*$"></asp:RegularExpressionValidator>
							</td>
                        </tr>
						<tr>
                            ...
                            <td style="height: 82px; text-align:left;">
                                <asp:ImageMap ID="imgGoodsPhoto" runat="server" Height="103px" Width="90px">
								 ...
								 <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="txtEmail"
                                    ErrorMessage="Please choose user picture！"></asp:RequiredFieldValidator><font color="red"></font></td>
                        </tr>
						<tr>
							<td style="width: 19px; height: 19px; text-align:center;">
                            </td>
                        ...
                        <tr>
                            ...
                            <td style="width: 40px; text-align:center;">
                              <asp:Button ID="btnInsert" runat="server" OnClick="btnInsert_Click"  Text="Modify" CssClass="hmf-button" /></td>
