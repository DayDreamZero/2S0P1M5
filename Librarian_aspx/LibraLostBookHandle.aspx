<%@ Page Language="C#" AutoEventWireup="true" CodeFile="LibraLostBookHandle.aspx.cs" Inherits="Librarian_aspx_LostBookHandle" %>
    ...
    <script>
        ...
        table.render({
          ...
          , cols: [[ //标题栏
            ...
            , {field: 'user_id', title: 'ReaderID', minWidth: 60}
            , { field: 'bookname', title: 'Book_name', minWidth: 180 }
            , { field: 'fine', title: 'Fine', minWidth: 60 }
            , { field: 'fine_status', title: 'Fine_status', minWidth: 110 }
            , { field: 'price', title: 'Price', minWidth: 60 }
        ...
        table.on('tool(test)', function (obj) { //注：tool是工具条事件名，test是table原始容器的属性 lay-filter="对应的值"
            ...
            if (layEvent === 'lost') { //丢失
                if (data["fine_status"] != "yes") {
                    window.location.href = "Libra-lost-temp.aspx?barcode=" + data["barcode"] +
                    "&fine=" + data["fine"] + "&price=" + data["price"] + "&fine_status=" +
                    data["fine_status"];
                }
            }
        });
