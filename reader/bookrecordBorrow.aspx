<%@ Page Language="C#" AutoEventWireup="true" CodeFile="bookrecordBorrow.aspx.cs" Inherits="reader_bookrecordBorrow" %>
...
<head runat="server">
    ...
    <title>Bibliosoft-borrowrecord</title>
        ...
        <div class="row">
            <div class="col-sm-2" style="border-right: solid 1px">
                <div class="list-group side-bar">
                    ...
                    <a href="bookrecordBorrow.aspx" class="list-group-item active">Borrow</a>
                            ...
                            <div class="row book-list">
                                <div class="book-list-item">
                                    ...
                                    <div class="book-info col-xs-5">
                                        ...
                                        <p>borrow date:<asp:Label ID="borrowTimeLab" runat="server" Text='<%#Eval("borrowed_date") %>'></asp:Label></p>
                                        <p style="color:brown;">please return this book before&nbsp;<asp:Label ID="Endtime" runat="server" Text='<%#Eval("endtime") %>'></asp:Label>&nbsp;</p>
                                        <p style="color: indianred">delay &nbsp&nbsp&nbsp fine:<asp:Label ID="fine" runat="server" Text='<%#Eval("fine") %>'></asp:Label></p>
                                    </div>
                                </div>
                            </div>
                            <p>
