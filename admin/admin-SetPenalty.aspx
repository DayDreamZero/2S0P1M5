<%@ Page Language="C#" AutoEventWireup="true" CodeFile="admin-SetPenalty.aspx.cs" Inherits="aspx_admin_SetPenalty" %>
...
<body>
    ...
    <footer class="navbar-fixed-bottom">
        <div style=" line-height: 23px;bottom:0;position:static;text-align:center;">
                <p class ="p1" align="center" style="margin-top: 10px;color: #878B91;font-size:14px;padding:0;position:static;padding-bottom:0;">
