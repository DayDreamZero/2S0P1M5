<%@ Page Language="C#" AutoEventWireup="true" CodeFile="admin-SetDeposit.aspx.cs" Inherits="aspx_admin_SetDeposit" %>
    ...
    <form id ="form1" runat="server" style="height:475px" onkeydown="return(event.keyCode!=13)">
       <div class ="container">
        <p>
            ...
            <br />
            <asp:Literal ID="literal2" runat ="server" Text ="You can set deposit for each reader here（unit: yuan）" Visible="True"></asp:Literal>    
        </p>
           <hr />
       </div>
