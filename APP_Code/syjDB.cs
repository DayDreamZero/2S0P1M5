...
public class syjDB
{
    ...
    private static SqlConnection getCon()
    {
        ...
        //return new SqlConnection("Data Source = (LocalDB)\\MSSQLLocalDB; AttachDbFilename = 'E:\\C#\\10-release1\\library system-3\\App_Data\\Database.mdf'; Integrated Security = True");
	...
	{
		SqlConnection con = syjDB.getCon();//连接数据库
		con.Open();//打开连接
	...
	{
		SqlConnection con = syjDB.getCon();//连接上数据库
