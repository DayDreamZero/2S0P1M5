<%@ Page Language="C#" AutoEventWireup="true" CodeFile="LibraRepurchaseBook.aspx.cs" Inherits="Librarian_aspx_RepurchaseBook" %>
...
<head runat="server">
    ...
    <title>BiblioSoft_RepurchaseBook</title>
...
<body>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-sm-10">
                <asp:Label ID="Label1" runat="server" Text="Repurchase Book" Font-Size="X-Large"></asp:Label>
