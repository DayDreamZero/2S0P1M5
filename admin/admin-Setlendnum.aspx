<%@ Page Language="C#" AutoEventWireup="true" CodeFile="admin-Setlendnum.aspx.cs" Inherits="aspx_admin_Setlendnum" %>
...
<body>
    ...
    <form id ="form1" runat="server" onkeydown="return(event.keyCode!=13)">
       <div class ="container">
        <p>
            <asp:Literal ID="literal1" runat ="server" Text ="For" Visible="True"></asp:Literal>
            <br />
            <asp:Literal ID="literal2" runat ="server" Text ="For" Visible="True"></asp:Literal>    
        </p>
           <hr />
       </div>
    ...
    <footer class="navbar-fixed-bottom">
        <div style=" line-height: 23px;bottom:0;position:static;text-align:center;">
                <p class ="p1" align="center" style="margin-top: 10px;color: #878B91;font-size:14px;padding:0;position:statics;">
