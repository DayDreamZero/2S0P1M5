...
public partial class aspx_admin_information_edit: System.Web.UI.Page
{
    ...
    {
        Response.Redirect("admin-information-show.aspx");
    }
    protected void Button2_Click(object sender, EventArgs e)
    {
        if (username.Text.TrimStart().TrimEnd() != string.Empty  && tel.Text.Trim() != string.Empty && email.Text.Trim() != string.Empty)
        {
                string sql = "UPDATE lm_admin set [name] = N'" + username.Text.ToString() + "',[telephone] = '" + tel.Text.ToString() + "',[email] = '" + email.Text.ToString() + "' where Id = " + HttpContext.Current.Session["admin_id"].ToString() + ";";
                ...
                if (System.IO.File.Exists(Server.MapPath(virpath)))
                {
                    ...
                    sql = "UPDATE lm_admin SET [picture] = '" + myPath + "' WHERE name = '" + username.Text + "';";
               ...
               /* else
                ...
                conn.Close();
                HttpContext.Current.Session["admin_name"] = username.Text;
                username.Text = null;
                tel.Text = null;
                email.Text = null;
