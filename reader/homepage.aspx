...
<body>
    ...
    <form runat="server">
        <div align="center" id="search-module">
            <div>
                ...
                <div align="center">
                    ...
                    <span style="color: white">search by category:</span><asp:DropDownList ID="category" runat="server" DataSourceID="SqlDataSource1" DataTextField="type_name" DataValueField="type_name">
                    </asp:DropDownList>
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=|DataDirectory|\Database.mdf;Integrated Security=True" ProviderName="System.Data.SqlClient" SelectCommand="SELECT DISTINCT [type_name] FROM [lm_booktype]"></asp:SqlDataSource>
                </div>
            </div>
        </div>
        <div id="hpbody">
            <div class="hp-rank">
                ...
                <div style="line-height: 10px; margin-top: 12px; margin-left: 20px; margin-right: 20px;">
                    <table width="100%" height="20px" style="table-layout: fixed; font-size: 14px; line-height: 20px; margin-left: 10px">
                        <tr>
                        ...
                        <asp:Repeater ID="Repeater2" runat="server" OnItemCommand="Repeater2_ItemCommand">
                            <ItemTemplate>
                                <li><span style="float: left">
                                    <asp:LinkButton ID="titleNotice" runat="server" Text='<%#Eval("title")%>' CommandArgument='<%#Eval("notice_id")%>' CommandName="detailNotice" /></span><span style="float: right; margin-right: 25px"><%#Eval("release_time")%></span></li>
                            </ItemTemplate>
                        </asp:Repeater>
                    </ol>
                </div>
