<%@ Page Language="C#" AutoEventWireup="true" CodeFile="admin-SetSendPeriod.aspx.cs" Inherits="admin_admin_SetSendPeriod" %>
...
<body>
    ...
    <form id ="form1" runat="server" style="height:475px" onkeydown="return(event.keyCode!=13)">
       <div class ="container">
        <p>
            <asp:Literal ID="literal1" runat ="server" Text ="  " Visible="True"></asp:Literal>
            <br />
            <asp:Literal ID="literal2" runat ="server" Text ="You can set period for overdue-books' reminding here(unit: day)" Visible="True"></asp:Literal>    
        </p>
           <hr />
       </div>
